...
export const metadata: Metadata = {
  title: "Vedanand | Backend Engineer & Full Stack Developer",
  description:
    "Portfolio of Vedanand, Backend Engineer and Full Stack Developer focused on distributed systems and scalable architectures.",
};
