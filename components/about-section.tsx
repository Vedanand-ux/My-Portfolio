    ...
    <section id="about" ref={sectionRef} className="pt-10 md:pt-14">
      ...
      >
        ...
        >
          ...
          >
            I am Peddaboina Vedanand, a software engineer based in Noida, Uttar Pradesh,
          ...
          >
            I built <BoxHighlight>Smart Cloud Storage System</BoxHighlight> and improved file
            management{" "}
            <MarkerHighlight>40% improvement in user workflow efficiency</MarkerHighlight>.
          </motion.p>
        </motion.div>
        ...
        <div className="mt-9">
          ...
          >
            ...
            <li>
              ...
              B.Tech ECE - Jaypee Institute of Information
              Technology, Noida (2022-2026)
            </li>
            <li>
